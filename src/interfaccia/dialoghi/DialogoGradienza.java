...
public class DialogoGradienza {
	...
	public JDialog getDialog(JFrame frame) {
		...
		gradientColor1Panel.add(new JLabel("Colore 1"));
		...
		gradientColor2Panel.add(new JLabel("Colore 2"));
		...
		gradientContentPanel.add(new DialogoGradienzaDraw(), BorderLayout.CENTER);
